 ...
 * - {@link ProgramaCreateFragment}: to create or edit a(n) ProgramaType,
 * - {@link ProgramaDetailFragment}: to display the details of a(n) ProgramaType,
 * - {@link ProgramaListFragment}: to list Programa.
 *
 ...
 * what to do.
 */
public class ProgramaActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ProgramaType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ProgramaListFragment} is
     * getting instantiated (which will load {@link ProgramaDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProgramaListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ProgramaType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ProgramaCreateFragment fragment = new ProgramaCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ProgramaType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProgramaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ProgramaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ProgramaType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ProgramaCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ProgramaActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ProgramaTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(ProgramaTypeViewModel.class);
