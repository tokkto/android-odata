...
import com.colusbisd.fonninez.databinding.FragmentMotivoDetailBinding;
...
/**
 * A fragment representing a single MotivoType detail screen.
 * This fragment is contained in an MotivoActivity.
 */
public class MotivoDetailFragment extends InterfacedFragment<MotivoType> {

    /** Generated data binding class based on layout file */
    private FragmentMotivoDetailBinding binding;

    /** MotivoType entity to be displayed */
    private MotivoType motivoTypeEntity = null;
    ...
    /** Arguments: MotivoType for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            motivoTypeEntity = entity;
            binding.setMotivoType(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<MotivoType> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, motivoTypeEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull MotivoType motivoTypeEntity) {
        if (EntityMediaResource.hasMediaResources(EntitySets.motivo)) {
        ...
        } else if (motivoTypeEntity.getDataValue(MotivoType.motivoDesc) != null && !motivoTypeEntity.getDataValue(MotivoType.motivoDesc).toString().isEmpty()) {
            objectHeader.setDetailImageCharacter(motivoTypeEntity.getDataValue(MotivoType.motivoDesc).toString().substring(0, 1));
        } else {
    ...
    /**
     * Setup ObjectHeader with an instance of MotivoType
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(motivoTypeEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(motivoTypeEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(motivoTypeEntity));
            ...
            setDetailImage(objectHeader, motivoTypeEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentMotivoDetailBinding.inflate(inflater, container, false);
