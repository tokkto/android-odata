 ...
 * - {@link AcuerdoCreateFragment}: to create or edit a(n) AcuerdoType,
 * - {@link AcuerdoDetailFragment}: to display the details of a(n) AcuerdoType,
 * - {@link AcuerdoListFragment}: to list Acuerdo.
 *
 ...
 * what to do.
 */
public class AcuerdoActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<AcuerdoType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link AcuerdoListFragment} is
     * getting instantiated (which will load {@link AcuerdoDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AcuerdoListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable AcuerdoType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        AcuerdoCreateFragment fragment = new AcuerdoCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable AcuerdoType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AcuerdoDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new AcuerdoDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable AcuerdoType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link AcuerdoCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((AcuerdoActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            AcuerdoTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(AcuerdoTypeViewModel.class);
