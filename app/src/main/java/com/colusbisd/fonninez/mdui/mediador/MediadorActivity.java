 ...
 * - {@link MediadorCreateFragment}: to create or edit a(n) MediadorType,
 * - {@link MediadorDetailFragment}: to display the details of a(n) MediadorType,
 * - {@link MediadorListFragment}: to list Mediador.
 *
 ...
 * what to do.
 */
public class MediadorActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MediadorType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MediadorListFragment} is
     * getting instantiated (which will load {@link MediadorDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MediadorListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MediadorType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MediadorCreateFragment fragment = new MediadorCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MediadorType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MediadorDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MediadorDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MediadorType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MediadorCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MediadorActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MediadorTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(MediadorTypeViewModel.class);
