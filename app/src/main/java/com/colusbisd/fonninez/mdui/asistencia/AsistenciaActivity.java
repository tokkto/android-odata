 ...
 * - {@link AsistenciaCreateFragment}: to create or edit a(n) AsistenciaType,
 * - {@link AsistenciaDetailFragment}: to display the details of a(n) AsistenciaType,
 * - {@link AsistenciaListFragment}: to list Asistencia.
 *
 ...
 * what to do.
 */
public class AsistenciaActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<AsistenciaType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link AsistenciaListFragment} is
     * getting instantiated (which will load {@link AsistenciaDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AsistenciaListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable AsistenciaType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        AsistenciaCreateFragment fragment = new AsistenciaCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable AsistenciaType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AsistenciaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new AsistenciaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable AsistenciaType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link AsistenciaCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((AsistenciaActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            AsistenciaTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(AsistenciaTypeViewModel.class);
