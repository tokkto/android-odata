 ...
 * - {@link SesionProgramadaCreateFragment}: to create or edit a(n) SesionProgramadaType,
 * - {@link SesionProgramadaDetailFragment}: to display the details of a(n) SesionProgramadaType,
 * - {@link SesionProgramadaListFragment}: to list SesionProgramada.
 *
 ...
 * what to do.
 */
public class SesionProgramadaActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<SesionProgramadaType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link SesionProgramadaListFragment} is
     * getting instantiated (which will load {@link SesionProgramadaDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SesionProgramadaListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable SesionProgramadaType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        SesionProgramadaCreateFragment fragment = new SesionProgramadaCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable SesionProgramadaType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SesionProgramadaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new SesionProgramadaDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable SesionProgramadaType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link SesionProgramadaCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((SesionProgramadaActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            SesionProgramadaTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(SesionProgramadaTypeViewModel.class);
