 ...
 * - {@link MotivoCreateFragment}: to create or edit a(n) MotivoType,
 * - {@link MotivoDetailFragment}: to display the details of a(n) MotivoType,
 * - {@link MotivoListFragment}: to list Motivo.
 *
 ...
 * what to do.
 */
public class MotivoActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MotivoType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MotivoListFragment} is
     * getting instantiated (which will load {@link MotivoDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MotivoListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MotivoType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MotivoCreateFragment fragment = new MotivoCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MotivoType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MotivoDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MotivoDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MotivoType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MotivoCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MotivoActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MotivoTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(MotivoTypeViewModel.class);
