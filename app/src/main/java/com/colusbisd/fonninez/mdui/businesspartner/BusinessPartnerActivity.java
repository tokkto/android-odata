 ...
 * - {@link BusinessPartnerCreateFragment}: to create or edit a(n) BusinessPartnerType,
 * - {@link BusinessPartnerDetailFragment}: to display the details of a(n) BusinessPartnerType,
 * - {@link BusinessPartnerListFragment}: to list BusinessPartner.
 *
 ...
 * what to do.
 */
public class BusinessPartnerActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<BusinessPartnerType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link BusinessPartnerListFragment} is
     * getting instantiated (which will load {@link BusinessPartnerDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new BusinessPartnerListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable BusinessPartnerType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        BusinessPartnerCreateFragment fragment = new BusinessPartnerCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable BusinessPartnerType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new BusinessPartnerDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new BusinessPartnerDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable BusinessPartnerType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link BusinessPartnerCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((BusinessPartnerActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            BusinessPartnerTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(BusinessPartnerTypeViewModel.class);
            ...
            builder.setPositiveButton(R.string.delete, (dialog,which) -> {
                try {
                    ...
                    ErrorHandler errorHandler = ((SAPWizardApplication)(getActivity().getApplication())).getErrorHandler();
                    ErrorMessage error = new ErrorMessage(getResources().getString(R.string.error),
                        getResources().getString(R.string.delete_failed_detail), ex, false);
