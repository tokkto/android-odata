...
import com.colusbisd.fonninez.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("com.colusbisd.fonninez:id/passcode_field")).setText(passcode);
